...
#include "tree-sitter/includes/api.h"
#include "tree-sitter/includes/parser.h"
...
static inline TSDiffHeap *ts_subtree_node_diff_heap(Subtree self) {
  if (self.data.is_inline) {
    return self.data.diff_heap;
  }
  return self.ptr->diff_heap;
}
#ifdef __cplusplus
}
#endif
